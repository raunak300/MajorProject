...
export default function Content() {
  return (
    <main className="flex flex-col text-white w-full">
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-16 px-6 bg-gradient-to-b from-purple-900/40 to-zinc-900">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">
          Express Yourself
          <span className="block text-purple-300">Anonymously with UNMUTE!</span>
        </h1>
        ...
        <button className="mt-8 text-lg font-medium text-white rounded-lg px-6 py-3 bg-purple-700/70 hover:bg-purple-700 transition-colors">
          Start Your Journey
        </button>
      </section>

      {/* Features Section */}
      <section className="py-12 px-6 bg-zinc-800">
      ...
      {/* Discover Section */}
      <section className="py-16 px-6 bg-gradient-to-b from-zinc-900 to-purple-900/30 text-center">
